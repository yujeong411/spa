...
<!-- container start -->
	<div class="container">
		...
		<div class="con_title">
			<h1 style="font-size: 50px;">会員加入</h1>
			...
			<form action="member.do" name="member" method="post">
						...
						<tr>
							...
							<td><input type="text" name="userid" id="userid" class="w300">
								<input type="hidden" name="reid">
								 <a href="javascript:idCheck();"style="padding: 6px; background: #e1e1e1; color: #333333;">重複確認</a></td>
						</tr>
				...
				<div class="btnArea Acenter pt60 pb100">
					<a href="javascript:history.go(-1);"
						class="btn_round btn_large btn_BlueGray w180"><b>キャンセル</b></a> <a
						href="javascript:fn_save();"
						class="btn_round btn_large btn_pointColor w180"><b>確認</b></a>
				</div>
			</form>
		</div>
	</div>
